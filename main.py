...
def help():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using CIOCAPIC              "+Fore.LIGHTCYAN_EX+"║\n")
...
def title():
    ...
    stdout.write("                                 "+Fore.LIGHTWHITE_EX  +"█▀▀ █ █▀█ █▀▀ ▄▀█ █▀█ █ █▀▀                \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   +"█▄▄ █ █▄█ █▄▄ █▀█ █▀▀ █ █▄▄               \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX   + "hekwas            ")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Welcome To The Main Screen Of Ciocapic  "+Fore.LIGHTCYAN_EX  +"       ║\n")
